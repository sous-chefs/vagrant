# Contributing to the vagrant cookbook

We are glad you want to contribute to the vagrant cookbook! The first
step is the desire to improve the project.

## Quick-contribute

* Create an issue on the github [issue tracker](https://github.com/sous-chefs/vagrant/issues)
...
on the sous-chef channel on [https://community-slack.chef.io/](https://community-slack.chef.io/)
